...
use crate::{
    ...
    model::{
        ...
        SubscribeFeedCommand, SubscribeFeedOutput, SubscribeFeedRefresh, TimelineChanged,
    ...
    P: FeedProvider,
{
    ...
    pub fn with_events(
        ...
        Self {
            ...
            reconciler: Reconciler::new(store, executor),
            config,
            events,
        }
    }

    pub fn subscribe_events(&self) -> crate::event::RegistryEventSubscriber {
