...
use crate::o11y::{OpenTelemetryGuard, tracing_subscriber::otel_metrics::metrics_event_filter};
    ...
    S: Subscriber + for<'span> LookupSpan<'span>,
{
    ...
    let resource = crate::o11y::opentelemetry::resource(service_name, service_version);
